...
var AutorotatePlugin = class extends import_core3.AbstractConfigurablePlugin {
  ...
  __onKeyPress(e) {
    if (this.viewer.state.keyboardEnabled && e.key === import_core3.CONSTANTS.KEY_CODES.Space && !e.ctrlKey && !e.altKey && !e.shiftKey && !e.metaKey) {
      this.toggle();
      e.preventDefault();
    }
  }
...
AutorotatePlugin.VERSION = "5.13.3";
